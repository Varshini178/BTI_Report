...
public class ExportBTI {
    ...
    public void Export() throws InterruptedException  {
    	...
    	export = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//glint-dropdown[@id ='reportExportDropdown']")));
    	
        export.click();
    	
        
        
        List<WebElement> exportList = driver.findElements(By.xpath("//ul[@class='dropdownMenuList']/li"));
    	for(WebElement powerpoint : exportList) {
    		if(powerpoint.getText().equals("Export Report to PowerPoint")) {
    			powerpoint.click();
